...
<div class="backAdmin">
        ...
        <a class = "section1" href="?section=read"><button class = "section btnAdmin" id="adminBtnAfficher" ><div class="admin-tile">Afficher</div></button></a>
        ...
        <a class = "section1" href="?section=create">
        <button class = "section btnAdmin" id="adminBtnAjouter"><div class="admin-tile">Ajouter</div></button></a>
        </div>
        </div>
