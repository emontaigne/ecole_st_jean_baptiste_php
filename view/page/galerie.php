<div class="mainTotalGallery">
    ...
    <p>Voici la galerie photo</p>
      ...
      <div class="containerGallery">
        <div id="activite1Gallery">
          <a href="#"
            ><h3 class="titreGallery">
              Promenade dans les bois <i id="fleche" class="fas fa-sort-down"></i
              ></i></h3
          ></a>
        </div>
        <div class="galleryImg d-flex" id="gallery1">
      ...
      <!-- Deuxième gallery photo-->

      <div class="containerGallery">
        <div id="activite2Gallery">
          <a href="#"
            ><h3 class="titreGallery">
      ...
      <!-- Troisième gallery photo-->

      <div class="containerGallery">
        <div id="activite3Gallery">
          <a href="#"
            ><h3 class="titreGallery">
              Activités en classes
              <i id="sort-down" class="fas fa-sort-down"></i
              ></h3
          ></a>
        </div>
